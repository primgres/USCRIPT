...
if %input%==2 if "%ORACLE_HOME%"=="O:\app\product\11.2.0\client_1" (setx ORACLE_HOME "С:\app\client\product\12.2.0\client_1")
if %input%==2 if "%OW_CONF_DIR%"=="P:\QA\CONF\OWE2E\conf_win" (setx OW_CONF_DIR "P:\QA\CONF\LSSE2E71\conf_win")
if %input%==2 if "%OW_SYSDATA_DIR%"=="O:\OpenWorks10.6" (setx OW_SYSDATA_DIR "С:\Landmark\OpenWorks")
if %input%==2 if "%OWHOME%"=="O:\OpenWorks10.6" (setx OWHOME "С:\Landmark\OpenWorks")
...
if %input%==2 if "%ORACLE_HOME%"=="С:\app\client\product\12.2.0\client_1" (setx ORACLE_HOME "O:\app\product\11.2.0\client_1")
if %input%==2 if "%OW_CONF_DIR%"=="P:\QA\CONF\LSSE2E71\conf_win" (setx OW_CONF_DIR "P:\QA\CONF\OWE2E\conf_win")
if %input%==2 if "%OW_SYSDATA_DIR%"=="С:\Landmark\OpenWorks" (setx OW_SYSDATA_DIR "O:\OpenWorks10.6")
if %input%==2 if "%OWHOME%"=="С:\Landmark\OpenWorks" (setx OWHOME "O:\OpenWorks10.6")
...
if %input%==2 if not defined ORACLE_HOME (setx ORACLE_HOME "С:\app\client\product\12.2.0\client_1")
if %input%==2 if not defined OW_CONF_DIR (setx OW_CONF_DIR "P:\QA\CONF\LSSE2E71\conf_win")
if %input%==2 if not defined OW_SYSDATA_DIR (setx OW_SYSDATA_DIR "С:\Landmark\OpenWorks")
if %input%==2 if not defined OWHOME (setx OWHOME "С:\Landmark\OpenWorks")
