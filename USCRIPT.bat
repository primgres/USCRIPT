...
if %input%==2 if "%ORACLE_HOME%"=="O:\app\product\11.2.0\client_1" (setx ORACLE_HOME "C:\app\client\product\12.2.0\client_1")
if %input%==2 if "%OW_CONF_DIR%"=="P:\QA\CONF\OWE2E\conf_win" (setx OW_CONF_DIR "P:\QA\CONF\LSSE2E71\conf_win")
if %input%==2 if "%OW_SYSDATA_DIR%"=="O:\OpenWorks10.6" (setx OW_SYSDATA_DIR "C:\Landmark\OpenWorks")
if %input%==2 if "%OWHOME%"=="O:\OpenWorks10.6" (setx OWHOME "C:\Landmark\OpenWorks")
if %input%==2 if "%TNS_ADMIN%"=="P:\QA\CONF\OWE2E\conf_win" (setx TNS_ADMIN "P:\QA\CONF\LSSE2E71\conf_win")
if %input%==2 if "%TNS_ADMIN%"=="P:\QA\CONF\OWE2E\conf_win" (echo "Switched to OW7")
if %input%==2 if "%LM_LICENSE_FILE%"=="2017@10.134.17.3;2013@10.134.19.88" (setx LM_LICENSE_FILE "2013@10.134.19.88")
if %input%==2 if "%ORACLE_HOME%"=="C:\app\client\product\12.2.0\client_1" (setx ORACLE_HOME "O:\app\product\11.2.0\client_1")
if %input%==2 if "%OW_CONF_DIR%"=="P:\QA\CONF\LSSE2E71\conf_win" (setx OW_CONF_DIR "P:\QA\CONF\OWE2E\conf_win")
if %input%==2 if "%OW_SYSDATA_DIR%"=="C:\Landmark\OpenWorks" (setx OW_SYSDATA_DIR "O:\OpenWorks10.6")
if %input%==2 if "%OWHOME%"=="C:\Landmark\OpenWorks" (setx OWHOME "O:\OpenWorks10.6")
if %input%==2 if "%TNS_ADMIN%"=="P:\QA\CONF\LSSE2E71\conf_win" (setx TNS_ADMIN "P:\QA\CONF\OWE2E\conf_win")
if %input%==2 if "%TNS_ADMIN%"=="P:\QA\CONF\LSSE2E71\conf_win" (echo "Switched to OW6")
...
if %input%==3 if "%OW_CONF_DIR%"=="P:\QA\CONF\LSSE2E71\conf_win" if "%TNS_ADMIN%"=="P:\QA\CONF\LSSE2E71\conf_win" (echo "Switched to LGAUTO1 district")
if %input%==3 if "%OW_CONF_DIR%"=="Y:\11.OWConfig\Win\OW_main" if "%TNS_ADMIN%"=="Y:\11.OWConfig\Win\OW_main" (echo "Switched to LSSE2E district")
